...
import 'package:flutter_application_5/views/item.dart';
...
class _SellerDetailsScreenState extends State<SellerDetailsScreen> {
              ...
              child: Card(
                child: Container(
                  ...
                  child: CachedNetworkImage(
                    ...
                    fit: BoxFit.cover,
                    imageUrl:
                        "http://192.168.56.1/bartlet/php/list_items/${widget.usercatch.userId}.png",
            ...
            child: Table(
              ...
              children: [
                ...
                TableRow(children: [
                  ...
                  TableCell(
                    child: Text(
                      "${widget.usercatch.locality}/${widget.usercatch.state}",
                    ),
                  )
                ]),
  ...
  // Other methods, such as fromJson and toJson, are also present in your code
}